# Garrett Motion KPI & Project Tracking Agent

## Overview

This is a comprehensive KPI and project tracking agent for Garrett Motion development programs. The agent monitors project health, analyzes engineering metrics, and provides executive-level insights for program management and steering committees. Built on top of Python, Streamlit, and FastAPI, KPI Hub monitors project health, calculates ASPICE & ISO 26262 compliance metrics, evaluates cross-system penalties, and delivers AI-powered executive insights for steering committees.
...
**Garrett Motion KPI Agent** — Enabling data-driven engineering decisions.
