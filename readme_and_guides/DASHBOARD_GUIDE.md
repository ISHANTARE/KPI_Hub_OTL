# 🚀 Garrett Motion KPI Hub Web Dashboard - User Guide

## Overview
The Garrett Motion KPI Hub is an enterprise-grade multi-page Streamlit web dashboard. It features role-based access control, a unified SQL operational database layer, automatic CSV-to-DB synchronization, and predictive AI insights tailored for automotive and engineering program management.
